const  Loading = ({w_h='40',color = "#711037" , padding}) => {
    return ( <div className={`flex w-full justify-center items-center py-[${padding ? padding : 0}rem]`}>
      <svg className="bg-transparent" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width={w_h} height={w_h} ><g><rect fill={color} height="40" width="15" y="30" x="17.5">
...
<rect fill={color} height="40" width="15" y="30" x="42.5">
...
<rect fill={color} height="40" width="15" y="30" x="67.5">
